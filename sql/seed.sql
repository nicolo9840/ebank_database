...
INSERT INTO Accounts (account_number, account_type, balance, status, opened_date, customer_id) VALUES ('IT84I020080950565756', 'Checking', 3580, 'Active', '2025-03-14', 1); 

INSERT INTO Accounts (account_number, account_type, balance, status, opened_date, customer_id) VALUES ('IT84I020000756567249', 'Savings', 10567, 'Active', '2025-03-10', 1); 

INSERT INTO Accounts (account_number, account_type, balance, status, opened_date, customer_id) VALUES ('IT86I500000758981644', 'Checking', 5032, 'Frozen', '2024-10-22', 2); 

INSERT INTO Accounts (account_number, account_type, balance, status, opened_date, customer_id) VALUES ('IT77I030000758981523', 'Savings', 15658, 'Active', '2025-06-29', 2); 

INSERT INTO Accounts (account_number, account_type, balance, status, opened_date, customer_id) VALUES ('DE54I037780356987684', 'Checking', 2054, 'Active', '2026-01-20', 3);
...
VALUES 
('Deposit', 600.00, 'Initial deposit', 'Completed', '2024-10-29  09:23:32', NULL, 2),
('Deposit', 450.00, 'Deposit', 'Completed', '2025-05-15 14:25:06', NULL, 5),
